...
import { changeText } from '../modules/organization_flow';
      ...
      <div>
        ...
        <Modal isOpen={this.state.modal}>
          <form onSubmit={this.handleSubmit}>
            ...
            <ModalBody>
              <Row>
                <Button bsStyle="info" onClick={changeText}>
                  Join Organization
                </Button>
                <Button bsStyle="danger">Create Organization</Button>
              </Row>
            </ModalBody>
            <ModalFooter>
              <input
...
export default connect(mapStateToProps, { changeText })(OrgModal);
